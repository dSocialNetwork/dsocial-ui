 ...
 * https://github.com/dsites/dsite-frontend/blob/4d4fe1f7da37d3dbb35bd0a131d9e5b44bad316d/app/utils/Links.js
 */
...
export const local = (flags = 'i') =>
  new RegExp(urlSet({ domain: '(?:localhost|(?:.*\\.)?dsite.io|(?:.*\\.)?dsocial.io)' }), flags);
export const remote = (flags = 'i') =>
  new RegExp(
    urlSet({ domain: `(?!localhost|(?:.*\\.)?dsite.io|(?:.*\\.)?dsocial.io)${domainPath}` }),
    flags,
  );
