...
/**
 * This function is extracted from dSite.io source code and does the same tasks with some slight-
 * adjustments to meet our needs. Refer to the main one in case of future problems:
 * https://github.com/dsites/dsite-frontend/blob/edac65e307bffc23f763ed91cebcb4499223b356/app/redux/TransactionSaga.js#L340
 *
 */
...
/**
 * https://github.com/dsites/dsite-frontend/blob/47fd0e0846bd8c7c941ee4f95d5f971d3dc3981d/app/utils/ParsersAndFormatters.js
 */
 ...
 * https://github.com/dsites/dsite-frontend/blob/47fd0e0846bd8c7c941ee4f95d5f971d3dc3981d/app/components/elements/Voting.jsx
 */
...
/**
 * Generate permlink
 * https://github.com/dsites/dsite-frontend/blob/ded8ecfcc9caf2d73b6ef12dbd0191bd9dbf990b/app/redux/TransactionSaga.js
 */
...
/**
 * https://github.com/dsites/dsite-frontend/blob/ded8ecfcc9caf2d73b6ef12dbd0191bd9dbf990b/app/redux/TransactionSaga.js#L412
 */
...
/**
 * https://github.com/dsites/dsite-frontend/blob/ded8ecfcc9caf2d73b6ef12dbd0191bd9dbf990b/app/redux/TransactionSaga.js#L329
 */
...
export const calculateTotalDelegatedBP = (user, totalVestingShares, totalVestingFundDPay) => {
  const receivedBP = parseFloat(
    formatter.vestToDPay(user.received_vesting_shares, totalVestingShares, totalVestingFundDPay),
  );
  const delegatedBP = parseFloat(
    formatter.vestToDPay(user.delegated_vesting_shares, totalVestingShares, totalVestingFundDPay),
  );
  return receivedBP - delegatedBP;
};
...
export const calculateEstAccountValue = (
  ...
  const dpayPower = formatter.vestToDPay(
    user.vesting_shares,
    totalVestingShares,
    totalVestingFundDPay,
  );
  return (
    parseFloat(dpayRate) * (parseFloat(user.balance) + parseFloat(dpayPower)) +
    parseFloat(user.bbd_balance) * parseFloat(bbdRate)
  );
};
