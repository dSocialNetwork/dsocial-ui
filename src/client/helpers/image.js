...
const IMG_PROXY = 'https://dsiteimages.com/0x0/';
const IMG_PROXY_PREVIEW = 'https://dsiteimages.com/600x800/';
const IMG_PROXY_SMALL = 'https://dsiteimages.com/40x40/';
...
export const getProxyImageURL = (url, type) => {
  if (url.indexOf('https://ipfs.dsocial.io') === 0 || url.indexOf('https://gateway.ipfs.io') === 0) {
    return url;
