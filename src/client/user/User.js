      ...
      <div className="main-panel">
        <Helmet>
          ...
          <meta
            ...
            content={image || 'https://cdn.benchx.io/dsocial/twitter.png'}
          />
        </Helmet>
        <ScrollToTopOnMount />
        {user && (
