...
import { imageRegex, dvideoImageRegex, rewriteRegex } from '../../helpers/regexHelpers';
import htmlReady from '../../vendor/dSiteHtmlReady';
...
export function getHtml(body, jsonMetadata = {}, returnType = 'Object', options = {}) {
  ...
  parsedBody = parsedBody.replace(dvideoImageRegex, '');
