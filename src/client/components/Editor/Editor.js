...
class Editor extends React.Component {
  ...
  setValues(post) {
    // NOTE: Used to rollback damaged drafts - https://github.com/dsocialnetwork/dsocial-ui/issues/1412
  ...
  render() {
    ...
    return (
      <Form className="Editor" layout="vertical" onSubmit={this.handleSubmit}>
        <Helmet>
          <title>
            {intl.formatMessage({ id: 'write_post', defaultMessage: 'Write post' })} - dSocial
          </title>
        </Helmet>
        <Form.Item
          label={
          ...
          {getFieldDecorator('reward')(
            <Select onChange={this.onUpdate} disabled={isUpdating}>
              <Select.Option value={rewardsValues.all}>
                <FormattedMessage id="reward_option_100" defaultMessage="100% BEX Power" />
              </Select.Option>
              <Select.Option value={rewardsValues.half}>
                <FormattedMessage id="reward_option_50" defaultMessage="50% BBD and 50% BP" />
              </Select.Option>
