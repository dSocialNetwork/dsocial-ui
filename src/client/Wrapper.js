...
import { login, logout, dsocialLogin } from './auth/authActions';
...
export default class Wrapper extends React.PureComponent {
  ...
  static async fetchData({ store, req, res }) {
    ...
    if (useBeta && appUrl === 'https://dsocial.io') {
      res.redirect(`https://staging.dsocial.io${req.originalUrl}`);
      return;
    }
