  ...
  render() {
    ...
    return (
      <div className="shifted">
        <Helmet>
          <title>{intl.formatMessage({ id: 'settings', defaultMessage: 'Settings' })} - dSocial</title>
        </Helmet>
              ...
              <div className="Settings">
                ...
                <div className="Settings__section">
                  ...
                  <p>
                    <FormattedMessage
                      id="language_info"
                      defaultMessage="What language do you want to use on dSocial?"
                    />
                  </p>
                  <Select
                ...
                <div className="Settings__section">
                  ...
                  <p>
                    <FormattedMessage
                      ...
                      defaultMessage="You can enable this option to replace dSite.io links with dSocial.io links."
                    />
                  </p>
                  <div className="Settings__section__checkbox">
                    <Checkbox
                ...
                <div className="Settings__section">
                  <h3>
                    <FormattedMessage id="use_beta" defaultMessage="Use dSocial beta" />
                  </h3>
                  <p>
                    <FormattedMessage
                      id="use_beta_details"
                      defaultMessage="You can enable this option to use dSocial beta by default."
                    />
                  </p>
                  <div className="Settings__section__checkbox">
