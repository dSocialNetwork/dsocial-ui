export default {
  ...
  BANDWIDTH_EXCEEDED: {
    ...
    message: 'Your bandwith has been exceeded. Please wait to transact or power up BEX.',
  },
  VOTING_POWER_TOO_SMALL: {
    fingerprint: 'abs_rshares > DPAY_VOTE_DUST_THRESHOLD',
    message: 'Your voting power is too small, please accumulate more voting power or BEX Power.',
  },
  UPVOTE_LOCKOUT: {
