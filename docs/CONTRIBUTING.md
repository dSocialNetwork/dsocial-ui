## Contributing to dSocial

Want to get involved in dSocial development? Thanks! There are plenty of ways you can help!
...
The [issue tracker](https://github.com/dsocialnetwork/dsocial-ui/issues) is the preferred channel
...
2. **Check if the issue has been fixed** &mdash; try to reproduce it on [the staging server](https://staging.dsocial.io/).
...
[good first issues](https://github.com/dsocialnetwork/dsocial-ui/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
or list of [help wanted issues](https://github.com/dsocialnetwork/dsocial-ui/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22).
...
2. Clone your fork locally:
   `git clone git@github.com:YourUsername/dsocial-ui.git`
...
7. Create a [pull request](https://github.com/dsocialnetwork/dsocial-ui/compare).
...
After some time (it can take few minutes) you should be able to see dSocial running at http://localhost:3000
...
https://github.com/dsocialnetwork/dsocial-ui/issues/1675
